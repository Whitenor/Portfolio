...
const projectList = [
    ...
    {name:"Technews", description: "Ce projet est un projet de stage, il avait pour but de créer un site avec le CMS Wordpress centré sur les métiers liés au développement informatique. Il ne faisait pas partie des choses que nous devions voir lors de la formation à ce moment là mais cela nous a donné un bon aperçus de la suite. La gestion du projet était faite par le formateur (Loic Dauchy). Il s'est déroulé en deux temps. Tout d'abord du 25 au 27 Avril 2022 , avec la répartition en deux groupes, l'un dédié à la création de la maquette, l'autre à la recherche de données pour constituer un jeu d'essai. La seconde partie du projet a eu lieu du 28 Avril au 05 Mai 2022 avec une nouvelle répartition en deux équipes. La première centrée sur l'intégration de la maquette via HTML/CSS, la seconde centrée sur tout les appels de données afin de faire fonctionner le site proprement. Pour les deux parties j'ai d'abord fait partie du groupe Maquette puis du groupe Appel de Données Pour des raisons d'hébergement actuel , je ne l'ai pas remis en ligne", link:"", screenshot:"assets/img/technews.jpg", periode:"du 25 Avril au 05 Mai 2022",typeProjet:"En groupe",techno:"HTML, CSS, JavaScript, Github , Git, PHP, Wordpress", repo:"https://github.com/Whitenor/Technews"},
    {name: "Allojyve", description:"Ce projet nous a servi d'introduction à l'utilisation d'API ainsi qu'a la création dynamique via Javascript. Son but était de récupérer une liste de films à partir de l'API de The Movie Database et de les afficher afin de voir les films selon différents critères. Les contraintes  pour ce projet étaient l'utilisation de l'API de The Movie Database et l'interdiction d'écriture de code en dur dans le HTML, tout devait être généré à partir du Javascript.", link:"https://www.allojyve.a-piron.fr", screenshot:"assets/img/allojyve.jpg", periode:"du 30 Mars au 24 Avril 2022",typeProjet:"En groupe",techno:"HTML, CSS, JavaScript, Github , Git",repo:"https://github.com/Whitenor/allojyve"}
];
